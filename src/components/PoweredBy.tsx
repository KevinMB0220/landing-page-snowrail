  ...
  const partners = [
    {
      ...
      icon: (
        <svg className="w-16 h-16" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M160.374 155.462C163.176 150.599 168.782 150.599 171.583 155.462L193.816 193.654C196.618 198.517 193.336 204.654 187.732 204.654H143.265C137.661 204.654 134.38 198.517 137.181 193.654L160.374 155.462Z" fill="white"/>
          <path d="M116.061 89.3462C118.862 84.4833 124.469 84.4833 127.27 89.3462L148.803 126.038L174.985 170.885C177.786 175.748 174.505 181.885 168.901 181.885H93.7292C88.1252 181.885 84.8438 175.748 87.6453 170.885L116.061 89.3462Z" fill="white"/>
        </svg>
      ),
    },
    {
